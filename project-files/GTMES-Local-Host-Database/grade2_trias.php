        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseG2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        ...
                        <a class="collapse-item active" href="grade2_trias.php">Trias</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">GRADE 2 TRIAS</h6>
                        </div>
                        <div class="card-body">
                        ...
                        $stmt = mysqli_query($con, "SELECT * from grade2_trias");
