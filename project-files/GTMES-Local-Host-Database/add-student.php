                ...
                <div class="card mb-4">
                                ...
                                <form class="user" method="POST">
                                    ...
                                    <!-- END SECTION -->    
                                        ...
                                        <input type="text" class="form-control" name="student_name" placeholder="Last Name, First Name, Middle Name">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="birth_date" placeholder="MM/DD/YYYY">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ethnic_group" placeholder="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                        <label for="house_no_street_sitio_purok" class="form-label">House #/Street/Sitio/Purok</label>
                                        <input type="text" class="form-control" name="house_no_street_sitio_purok" placeholder="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="municipality" placeholder="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="father_name" placeholder="Last Name, First name, Middle Name">
                                        </div>
                                        <div class="form-group">
                                        <label for="maiden_mother_name" class="form-label">Maiden Mother Name</label>
                                        <input type="text" class="form-control" name="maiden_mother_name" placeholder="Last Name, First name, Middle Name">
                                        </div>
                                        <div class="form-group">
                                        <label for="guardian_name" class="form-label">Guaridan Name</label>
                                        ...
                                        <input type="text" class="form-control" name="guardian_relationship" placeholder="">
                                        </div>
                                        <div class="form-group">
                                        <label for="guardian_number" class="form-label">Guardian Number</label>
                                        <input type="text" class="form-control" name="guardian_number" placeholder="">
                                        </div>
                                        <div class="form-group">
                                        <label for="Learning Modality" class="form-label">Learning Modality</label>
                                        <input type="text" class="form-control" name="learning_modality" placeholder="">
                                        </div>
                                        <div class="form-group">
