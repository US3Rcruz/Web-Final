            ...
            <li class="nav-item active">
                ...
                <div id="collapseG3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="grade3_mojica.php">Mojica</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">GRADE 3 MOJICA</h6>
                        </div>
                        <div class="card-body">
                        ...
                        $stmt = mysqli_query($con, "SELECT * from grade3_mojica");
